...
// import HeaderSearch from '../HeaderSearch'; // Hapus baris ini
import Head from 'next/head';
import LanguageMenu from '../LanguageMenu';

const Header2 = ({ dictionary, currentLang }) => {
          ...
          <div className="main-header-row">
            ...
            <div className="header-right-group">
              <div className="search-currency-wrapper">
                {/* <HeaderSearch dictionary={dictionary} currentLang={currentLang} /> // Hapus baris ini */}
