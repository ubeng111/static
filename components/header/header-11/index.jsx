...
// import LanguageMenu from '../LanguageMenu'; // Hapus import LanguageMenu

// Hapus prop dictionary dan currentLang
const Header1 = () => {
  const [navbar, setNavbar] = useState(false);

  // Hapus inisialisasi dictionary
        ...
        <div className="header__container">
          <div className="main-header-row">
            <div className="header-left-group">
              {/* MODIFIKASI INI: Hapus ${currentLang} dari href */}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Organization',
              name: 'Hoteloza',
              // Ganti commonDict.callToActionsDescription dengan string statis
