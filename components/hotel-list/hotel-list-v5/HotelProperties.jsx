...
const HotelProperties = ({ hotels }) => {
  ...
  return (
    <>
      {hotels.map((item) => (
        <div
          className="col-lg-3 col-md-4 col-6 mb-30" // Added mb-30 for vertical spacing
          key={item?.id}
          data-aos="fade"
        ...
        >
          ...
          >
            ...
            <div className="hotelsCard__content mt-10">
              ...
              {/* Review Section - moved next to rating */}
              <div className="d-flex align-items-center mt-20">
                <div className="flex-center bg-blue-1 rounded-4 size-30 text-12 fw-600 text-white">
                  {item?.ratings}
                </div>
                <div className="text-14 text-dark-1 fw-bold ml-10"> {/* Bold review text */}
