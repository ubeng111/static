// app/api/all-city-paths/route.js
...
export async function GET() {
  ...
  try {
    ...
    const result = await client.query(`
      ...
      JOIN
        public.categories c ON c.name = 'Hotel'; -- Asumsi kategori 'Hotel' untuk kota ini
      WHERE
    ...
    console.error('Error fetching all city paths:', error);
    return NextResponse.json({ message: 'Internal Server Error fetching city paths' }, { status: 500 });
  } finally {
