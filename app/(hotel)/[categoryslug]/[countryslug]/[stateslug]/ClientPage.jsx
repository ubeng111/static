...
const Faqstate = dynamic(() => import('@/components/faq/Faqstate'), { ssr: false }); // Ensure Faqstate is imported
...
export default function ClientPage({
  ...
  stateslug,    // Pastikan ini diterima dari page.jsx
  longDescriptionSegments,
  formattedCategory,
  formattedCountry,
  formattedState,
  displayState, // Assuming displayState is the formatted name for the state
}) {
            ...
            <div className="col-12">
              <div className="text-center">
                <h1 className="text-30 fw-600 text-white">
                  {`Discover Best ${formattedCategory} Options in ${displayState}, ${formattedCountry}`}
                </h1>
          ...
          <div className="row">
            <div className="col-12">
              <h2 className="text-24 fw-600 mb-20">
                {`About Our ${formattedCategory} Collection in ${displayState}`}
              </h2>
            ...
            <div className="row y-gap-20">
              <div className="col-12 text-center">
                <h2 className="text-22 fw-500">
                  {`Frequently Asked Questions About ${formattedCategory} in ${displayState}`}
                </h2>
              </div>
              <div className="col-lg-8 offset-lg-2">
                <div className="accordion -simple row y-gap-20 js-accordion">
                  {/* Pastikan Anda meneruskan semua slug yang diperlukan ke Faqstate */}
                  <Faqstate
                    state={displayState}
                    ...
                    stateslug={stateslug}      // <<< Pastikan ini diteruskan
                  />
                </div>
              </div>
            </div>
