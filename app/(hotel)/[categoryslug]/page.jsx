...
export async function generateMetadata({ params }) {
  ...
  // Meskipun secara teknis `params` sudah tersedia, ini adalah requirement dari Next.js.
  const awaitedParams = await params; // Menunggu params sesuai petunjuk Next.js
  const categoryslug = awaitedParams.categoryslug; // Mengakses properti setelah awaited
