...
export async function generateMetadata({ params }) {
  ...
  if (landmarkData) {
    ...
    landmarkUrl = `${baseUrl}/${locale}/landmark/${slug}`; 
  } else {
...
// --- PERBAIKAN KRITIS DI SINI UNTUK MENGATASI RangeError ---
// Mengembalikan array kosong karena jumlah slug terlalu besar untuk SSG penuh.
// Halaman akan dirender on-demand (SSR/ISR) saat permintaan masuk.
export async function generateStaticParams() {
  console.warn("SERVER WARN: generateStaticParams for landmarks returning empty array to prevent 'Maximum call stack size exceeded' due to large dataset. Pages will be rendered on-demand (ISR)."); 
